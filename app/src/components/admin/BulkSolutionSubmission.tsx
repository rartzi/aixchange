...
export function BulkSolutionSubmission() {
  ...
  return (
    <Card className="p-6">
      <h2 className="text-2xl font-bold mb-4">Bulk Solution Submission</h2>
      
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium mb-2">
            Select Solutions JSON File
          </label>
          <input
            type="file"
            accept=".json"
        ...
        <Button
          ...
          className="w-full"
        >
          {isLoading ? 'Submitting...' : 'Submit Solutions'}
        </Button>
